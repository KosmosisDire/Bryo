...
// Formatting helpers
#define LOG_HEADER(title, ...) Mycelium::Scripting::Common::Logger::get_instance().header(title, ##__VA_ARGS__)
#define LOG_SUBHEADER(title, ...) Mycelium::Scripting::Common::Logger::get_instance().subheader(title, ##__VA_ARGS__)
#define LOG_SEPARATOR(...) Mycelium::Scripting::Common::Logger::get_instance().separator(__VA_ARGS__)
#define LOG_PROGRESS(operation, ...) Mycelium::Scripting::Common::Logger::get_instance().progress(operation, ##__VA_ARGS__)
#define LOG_BLANK() Mycelium::Scripting::Common::Logger::get_instance().blank_line()
