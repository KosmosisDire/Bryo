...
// Interface for receiving lexer diagnostics
class LexerDiagnosticSink {
public:
    virtual ~LexerDiagnosticSink() = default;
    virtual void report_diagnostic(const LexerDiagnostic& diagnostic) = 0;
};
...
public:
    ...
    Lexer(std::string_view source, 
          ...
          LexerDiagnosticSink* diagnostic_sink = nullptr);
...
private:
    ...
    LexerDiagnosticSink* diagnostic_sink_;
    size_t error_count_;
